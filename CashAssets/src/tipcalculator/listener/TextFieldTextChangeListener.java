...
/**
 * The Listener, that listens to Text Changes in all TextFields of the TipCalculator.
 * @author Haeldeus
 * @version 1.0
 */
public class TextFieldTextChangeListener implements ChangeListener<String> {
  ...
  /**
   * The GridPane, where the TextFields for the Staff Members were added to.
   */
   ...
   * @since 1.0   
   */
  public TextFieldTextChangeListener(boolean exact, GridPane grid, 
  ...
  public void changed(ObservableValue<? extends String> arg0, String oldText, String newText) {
    ...
    if (primary.getTfTip().getText() != null && !primary.getTfTip().getText().equals("")) {
      ...
      txt = txt.replaceAll(",", "\\.");
      /*
       * If there was no numerical input, the text is changed to 0 to prevent RunTimeErrors.
       */
      if (txt.equals("")) {
        txt = "0";
      }
